...
- `errors`
    - **description:** A table with all unsent messages and reasons for why these were aborted. If an error is encountered when sending any message, the error is recorded in this table and the process continues; the component does not exit on encoutered error.
    - **load type:** incremental
