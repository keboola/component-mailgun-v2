...
class MailgunApp(ComponentBase):
    ...
    def __init__(self):
        ...
        self.writerMessages = MailgunWriter(dataPath=self.files_out_path, tableName='messages', tableFields=MESSAGES_FIELDS,
                                            primaryKeys=MESSAGES_PK, incremental=True)
        self.writerErrors = MailgunWriter(dataPath=self.files_out_path, tableName='errors', tableFields=ERRORS_FIELDS,
